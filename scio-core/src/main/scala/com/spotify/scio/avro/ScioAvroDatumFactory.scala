 ...
 */
private[scio] object ScioGenericRecordDatumFactory extends AvroDatumFactory.GenericDatumFactory {
 ...
 * when joining or as SMB keys as it doest not implement equals
 */
private[scio] class ScioSpecificRecordDatumFactory[T <: SpecificRecord](recordType: Class[T])
